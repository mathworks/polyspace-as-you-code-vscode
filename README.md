...
- [For Windows](https://www.mathworks.com/PaYC_Installer_25a_win64)
- [For Linux](https://www.mathworks.com/PaYC_Installer_25a_glnx64)
- [For Mac (intel)](https://www.mathworks.com/PaYC_Installer_25a_maci64)
...
1. Open the settings ( **Ctrl**+**,** ) and configure the `polyspace.analysisengine` settings:
   * **Polyspace Installation Folder**: Path to your Polyspace as You Code installation. For instance:
      - **Windows**: `C:\Program Files\Polyspace as You Code\R2025a`
      - **Linux**: `/usr/local/PolyspaceAsYouCode/R2025a`
...
Depending on your build system, you might need to modify the `polyspace.analysisOptions` settings before running an analysis. See the **[Polyspace as You Code Documentation](https://www.mathworks.com/help/releases/R2025a/bugfinder/polyspace-as-you-code-in-visual-studio-code.html)**.
...
![Analyze files on save](https://github.com/mathworks/polyspace-as-you-code-vscode/raw/HEAD/resources/walkthroughs/configure/automaticLaunchOnSave.gif)
...
![Automatically fix findings](https://github.com/mathworks/polyspace-as-you-code-vscode/raw/HEAD/resources/walkthroughs/reviewResults/automaticallyFixFindings.gif)
...
![Show only new results compared to Access baseline](https://github.com/mathworks/polyspace-as-you-code-vscode/raw/HEAD/resources/walkthroughs/baseline/accessBaselineNewResultsOnly.gif)
